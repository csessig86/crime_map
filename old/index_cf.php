...
<table id="intro_table">
	<tr>
		...
		<p>The map is color coded depending on the type of call. Click on the markers on the map for more information on the call. Select a month below to filter the number of reported crimes that are pinpointed on the map. <strong>Note:</strong> This map does currently include crimes reported by the University of Northern Iowa police department. Those can be found by <a href="http://www.vpaf.uni.edu/pubsaf/crime_stats/log/index.shtml" target="_blank">clicking here</a>.</p>
...
<iframe class="map_embed" height="1600" width="940" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src='templates/cf/map_index_sept.php'></iframe>
